...
def build_weather_agent(session_id: str, user_config: dict | None = None) -> Agent:
    ...
    agent = Agent(
        ...
        system_prompt=(
            "You are a helpful weather agent that provides weather forecasts for specific locations and dates."
